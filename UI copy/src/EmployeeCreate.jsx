            ...
            <div>
                ...
                <form name="addEmployeeForm" onSubmit={this.handleAddEmployee}>
                    ...
                    <div className="row">
                        ...
                        <TextField id="firstName" label="Enter your first name" variant="outlined" required />
                            {/* <label htmlFor="firstName" className="form-label">First Name</label> :-
                            <input type="text" className="form-control" id="firstName" name="firstName" placeholder="First Name" required /> */}
                        </div>
                        <br />
                        <div className="col-md-6">
                        <TextField id="lastName" label="Enter your last name" variant="outlined" required />
